  ...
  <div class="w-full max-w-[560px] border-grid bg-canvas flex flex-col">
    ...
    <div class="p-6 sm:p-10 flex flex-col">
      ...
      <p class="text-xs sm:text-sm font-semibold text-slate mb-8 pb-4 border-b-[3px] border-charcoal">
        Isi formulir di bawah ini untuk mendaftarkan akun sesi latihan Anda.
      </p>
      ...
      <form action="/register" method="POST" class="space-y-6">
        ...
        <div class="flex flex-col gap-2">
          ...
          <input 
            ...
            name="name" 
            required 
            placeholder="CONTOH: ZAKI YULIAN" 
    ...
    <div class="border-t-grid bg-light p-4 text-center">
      <a href="/login" class="font-mono text-xs font-bold uppercase tracking-widest text-charcoal hover:text-ember transition-colors">
